...
public enum IoOperationType {
    ...
    // private static final int RWBS_FLAG_DISCARD = 1 << 1;
    private static final int RWBS_FLAG_READ = 1 << 2;
    private static final int RWBS_FLAG_RAHEAD = 1 << 3;
    // private static final int RWBS_FLAG_BARRIER = 1 << 4;
    // private static final int RWBS_FLAG_SYNC = 1 << 5;
    // private static final int RWBS_FLAG_META = 1 << 6;
    // private static final int RWBS_FLAG_SECURE = 1 << 7;
    private static final int RWBS_FLAG_FLUSH = 1 << 8;
    // private static final int RWBS_FLAG_FUA = 1 << 9;
