...
/**
 * Interface for the various graph edges
 *
...
public interface ITmfEdge {
     ...
     *            The edge type
     */
    void setEdgeType(final EdgeType type);
     ...
     * @since 2.1
     */
    void setEdgeType(EdgeType type, @Nullable String linkQualifier);
