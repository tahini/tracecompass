...
public abstract class AbstractSegmentStoreTableViewer extends TmfSimpleTableViewer {
     ...
     * once its store is fully completed
     */
    ...
    /**
     * Set the data into the viewer. if the viewer is an analysis, it will
     * update model if the analysis is completed or run the analysis if not
     * completed
     *
     * @param provider
